...
<head>
    ...
    <link href="<?= base_url('assets/backand/') ?>css/sb-admin-2.min.css" rel="stylesheet">
                            ...
                            <div class="col-lg">
                                <div class="p-3">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Sistem Pendaftaran Siswa Baru</h1>
                                    </div>
                                    <form class="user" method="post" action="<?= site_url('auth/login') ?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="username" name="username" aria-describedby="emailHelp" placeholder="Username" autocomplete="off">
                                        </div>
                                        <div class="form-group">
